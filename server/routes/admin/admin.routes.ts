...
import { updateMessageValidator, userActivationValidator } from "@/middlewares/validators/userActivationValidator";
...
adminRouter.put("/update", updateMessageValidator(), async (req: Request, res: Response) => {
  try {
